...
import '../../../presentation/widgets/localized_specialty_autocomplete_field.dart';
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                LocalizedSpecialtyAutocompleteField(
                  ...
                  validator: (specialty) =>
                      specialty == null ? l10n.fieldRequired : null,
                ),
                if (_error != null) ...[
